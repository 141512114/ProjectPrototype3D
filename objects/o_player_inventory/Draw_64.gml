...
for (var __i = 0; __i < ds_list_size(__inventory); __i++) {
    ...
    var __sprite_scale_x = 64 / __sprite_w, __sprite_scale_y = 64 / __sprite_h;
    var __sprite_scaled_w = __sprite_w * __sprite_scale_x;
    ...
    draw_sprite_ext(
        ...
        0,
        (__screen_w / 2 + (__sprite_scaled_w + __gap) * __i - ((__sprite_scaled_w + __gap) / 2) * (ds_list_size(__inventory) - 1)) - __sprite_scaled_w / 2,
        __screen_y - __sprite_h * __sprite_scale_y - 32,
        __sprite_scale_x, __sprite_scale_y, 0, c_white, 1
        );
}
